...
@Component({
  ...
  templateUrl: './demo4-field.component.html',
  styleUrls: ['./demo4-field.component.css']
})
export class Demo4FieldComponent extends BpmFwWriteComponent implements OnInit {
