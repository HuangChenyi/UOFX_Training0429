...
@Component({
  ...
  templateUrl: './optional5-field.component.html',
  styleUrls: ['./optional5-field.component.css']
})
export class Optional5FieldComponent extends BpmFwWriteComponent implements OnInit {
