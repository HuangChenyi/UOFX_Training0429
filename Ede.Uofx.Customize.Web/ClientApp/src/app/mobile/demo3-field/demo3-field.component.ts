...
@Component({
  ...
  templateUrl: './demo3-field.component.html',
  styleUrls: ['./demo3-field.component.css']
})
export class Demo3FieldComponent extends BpmFwWriteComponent implements OnInit {
