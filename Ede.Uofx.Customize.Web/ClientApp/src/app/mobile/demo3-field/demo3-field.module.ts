...
import { Demo3FieldComponent } from './demo3-field.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      { path: '', component: Demo3FieldComponent, pathMatch: 'full' }
    ]),
...
export class Demo3AppFieldModule {
  static comp = {
    write: Demo3FieldComponent,
    view: Demo3FieldComponent
  }
}
