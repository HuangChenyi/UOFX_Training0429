...
const COMPONENTS = [Demo3FieldPropsComponent, Demo3FieldWriteComponent];
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      ...
      { path: 'design', component: Demo3FieldWriteComponent },
      { path: 'props', component: Demo3FieldPropsComponent },
      { path: 'write', component: Demo3FieldWriteComponent },
      { path: 'view', component: Demo3FieldWriteComponent },
      { path: 'print', component: Demo3FieldWriteComponent },
      //有app開發後再實作這段
      {
        path: 'app',
        loadChildren: () => import('../../mobile/demo3-field/demo3-field.module').then(m => m.Demo3AppFieldModule)
      }
    ]),
...
export class Demo3FieldModule {
  static comp = {
    props: Demo3FieldPropsComponent,
    design: Demo3FieldWriteComponent,
    write: Demo3FieldWriteComponent,
    view: Demo3FieldWriteComponent,
    print: Demo3FieldWriteComponent,
  };
}
